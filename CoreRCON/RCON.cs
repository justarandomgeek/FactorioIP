...
namespace CoreRCON
{
	public partial class RCON : IDisposable
	{
		...
		private Dictionary<int, Action<RCONPacket>> _pendingCommands { get; } = new Dictionary<int, Action<RCONPacket>>();
		...
		/// </summary>
		public RCON(string host, ushort port, string password, uint reconnectDelay = 30000)
		{
            _host = host;
            _port = port;
			_password = password;
		...
		public async Task ConnectAsync()
		{
            ...
            _tcp.ReceiveBufferSize = Constants.MAX_PACKET_SIZE;
